...
import type { Client, ClientStatus, Invoice, InvoiceStatus, Project } from '../types'
...
export default function ClientDetail() {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      setProjects((p as Project[] | null) || [])
      setInvoices((i as Invoice[] | null) || [])
      setLoading(false)
    }
    load()
    return () => {
                ...
                <div className="flex items-center gap-2 flex-wrap mb-1">
                  ...
                  <span
                    className={cn(
                      ...
                      CLIENT_STATUS_STYLES[client.status as ClientStatus] || CLIENT_STATUS_STYLES.inactive
                    )}
                  >
                    {client.status}
                  </span>
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <span
                        className={cn(
                          'text-[10px] font-semibold uppercase tracking-wide px-2 py-0.5 rounded-md',
                          INVOICE_STYLES[inv.status as InvoiceStatus]
                        )}
                      >
                        {inv.status}
                      </span>
