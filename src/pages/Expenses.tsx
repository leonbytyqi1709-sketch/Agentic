...
import type { ExpenseCategory, ExpenseInsert, ExpenseWithRelations } from '../types'
...
export default function Expenses() {
  ...
  function openEdit(exp: ExpenseWithRelations) {
    setEditing(exp)
    setForm({
                  ...
                  <td className="px-5 py-3">
                    <span
                      className={cn(
                        ...
                        CATEGORY_STYLES[e.category as ExpenseCategory]
                      )}
                    >
                      {e.category}
                    </span>
