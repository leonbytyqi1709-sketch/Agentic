...
import type { InvoiceItem, InvoiceStatus, InvoiceWithRelations } from '../types'
          ...
          <div id="invoice-print" className="bg-white text-black rounded-xl p-10 shadow-card print:shadow-none print:rounded-none">
              ...
              <div className="text-right">
                ...
                <span
                  className={cn(
                    ...
                    STATUS_STYLES[invoice.status as InvoiceStatus] || STATUS_STYLES.draft,
            ...
            <div className="grid grid-cols-2 gap-6 mb-8 text-sm">
              <div>
                ...
                <div className="font-bold text-black">{invoice.clients?.name || '—'}</div>
