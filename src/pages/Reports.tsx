...
export default function Reports() {
  ...
  const revenueByClient = useMemo<RevenueByClient[]>(() => {
  ...
  const monthlyRevenue = useMemo<MonthlyRevenueDatum[]>(() => {
    const months: MonthlyRevenueDatum[] = Array.from({ length: 12 }, (_, i) => {
      const d = new Date()
