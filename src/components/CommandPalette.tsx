...
export default function CommandPalette() {
  ...
  const actions: CommandItem[] = useMemo(
    () => [
      ...
      { id: 'nav-quotes', label: 'Go to Quotes', icon: FileSignature, kind: 'Action', action: () => navigate('/quotes') },
      { id: 'nav-invoices', label: 'Go to Invoices', icon: FileText, kind: 'Action', action: () => navigate('/invoices') },
      { id: 'nav-recurring', label: 'Go to Recurring', icon: Repeat, kind: 'Action', action: () => navigate('/recurring') },
